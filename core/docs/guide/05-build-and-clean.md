...
The [Opening a PR playbook](../../skills/poteto-mode/playbooks/opening-a-pr.md) applies [`/unslop`](../../skills/unslop/SKILL.md) to the diff before each commit and to the PR description and commit bodies: remove narrating comments, unsupported guards, dead compatibility paths, and unrelated edits.
