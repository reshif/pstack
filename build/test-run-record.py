...
says about it. Case `edited_harness` is the failure from
audits/2026-09-10-bugfix-run-736701de.md: the fix commit edited the harness, and
only the original harness exposed the lost email.
"""
import os
import re
import subprocess
...
SCRIPT = Path(__file__).resolve().parent.parent / "core/skills/poteto-mode/scripts/run-record.py"
